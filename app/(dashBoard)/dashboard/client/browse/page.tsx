                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                        <div>
                            ...
                            <div className="inline-flex items-center gap-2 mb-4 px-3 py-1.5 rounded-full
                                bg-indigo-500/10 dark:bg-indigo-500/10 border border-indigo-500/20
                        ...
                        {filtered.map((f) => {
                            ...
                            const scoreBg =
                                score >= 90 ? 'bg-emerald-500/10 border-emerald-500/20' :
                                    score >= 70 ? 'bg-indigo-500/10 border-indigo-500/20' :
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => router.push(`/freelancers/${f._id}`)}
                                >
                                    {/* Hover glow */}
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className="relative">
                                            ...
                                            <span className="absolute -bottom-1 -right-1 w-3.5 h-3.5
                                                ...
                                                border-2 border-white dark:border-[#0e1020]" />
                                        </div>
