...
//                 className="text-xs text-indigo-500 border border-indigo-500/30 px-4 py-2 rounded-full hover:bg-indigo-500/10 transition-all">
//                 ← Back
//             </button>
//         </div>
//     )
...
//                                     />
//                                 ) : (
//                                     <div className="w-[72px] h-[72px] rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white text-2xl font-black tracking-tight">
//                                         {initials}
//                                     </div>
//                                 )}
//                             </div>
...
//                         <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-slate-900 dark:text-white leading-[1.02] mb-3">
...
//                                 <span className="inline-flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-white/[0.04] border border-slate-200 dark:border-white/[0.07] px-3 py-1.5 rounded-full">
...
//                                     className="inline-flex items-center gap-1.5 text-xs text-indigo-500 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 px-3 py-1.5 rounded-full hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition-colors">
...
//                                 borderRadius: '50%',
//                             }}>
//                             <div className="absolute inset-[6px] rounded-full bg-white dark:bg-[#0a0b14] flex flex-col items-center justify-center gap-0.5">
...
//                             <p className="text-xs font-semibold mt-0.5" style={{ color: scoreAccent }}>{scoreLabel}</p>
//                         </div>
//                     </div>
//                 </div>
...
//                                     <div key={skill}
//                                         className="flex items-center justify-between px-4 py-2.5 bg-slate-50 dark:bg-white/[0.03] border border-slate-100 dark:border-white/[0.06] rounded-xl hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:bg-indigo-50/50 dark:hover:bg-indigo-500/[0.05] transition-all duration-200 cursor-default">
...
//                     {canReview && (
//                         <div className="mb-8 p-6 rounded-2xl bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08]">
...
//                                 {submitMsg && (
//                                     <p className={`text-xs ${submitMsg.startsWith('✓') ? 'text-emerald-500' : 'text-red-400'}`}>
//                                         {submitMsg}
//                                     </p>
//                                 )}
//                                 <button
...
//                                                     stroke={review.rating >= star ? '#f59e0b' : '#94a3b8'}
//                                                 />
//                                             ))}
//                                         </div>
//                                     </div>
...
//                 {/* CTA */}
//                 <div className="relative overflow-hidden rounded-[2rem] bg-slate-900 dark:bg-white/[0.03] border border-slate-800 dark:border-white/[0.08] p-8 sm:p-10">
//                     <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-indigo-600/20 blur-3xl pointer-events-none" />
//                     <div className="absolute -bottom-16 -left-10 w-48 h-48 rounded-full bg-violet-600/10 blur-3xl pointer-events-none" />
//                     <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
//                         <div>
//                             <p className="text-[10px] uppercase tracking-[0.2em] text-slate-500 mb-2">Next step</p>
...
//                             className="group flex-shrink-0 inline-flex items-center gap-3 px-7 py-3.5 rounded-2xl font-bold text-sm bg-indigo-500 hover:bg-indigo-400 text-white active:scale-95 transition-all duration-200"
//                         >
//                             Send Proposal
